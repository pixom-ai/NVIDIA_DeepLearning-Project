...
net:add(nn.SpatialConvolutionMM(64,128, 3,3, 1,1, 1,1))         -- 96 -> 96 
...
net:add(nn.SpatialBatchNormalization(128,1e-3))
net:add(nn.ReLU(true))
net:add(nn.SpatialConvolutionMM(128,256, 3,3, 1,1, 1,1))       -- 24 -> 24 
...
net:add(nn.SpatialBatchNormalization(256,1e-3))
net:add(nn.ReLU(true))
net:add(nn.SpatialConvolutionMM(256,512, 3,3, 1,1, 1,1))       -- 6 -> 6 
net:add(nn.SpatialBatchNormalization(512,1e-3))
net:add(nn.ReLU(true))
net:add(nn.SpatialMaxPooling(3,3,3,3):ceil())                  -- 6 -> 2


net:add(nn.View(2048))   -- 256*2*2
classifier = nn.Sequential()
classifier:add(nn.Dropout(0.5))
classifier:add(nn.Linear(2048,256))
